 ...
 *
 * $Id: T4.java,v 1.7 2015/10/30 14:18:51 rchimiak Exp $
 *
...
/**
 * The T4 class implements the transformation between the GSM and SM geocentric
 * coordinate systems.
 *
 * @author rchimiak
 * @version $Revision: 1.7 $
 */
public class T4 extends Transform3D {
     ...
     */
    public T4(double mjd, double hours) {

        Mu mu = new Mu(mjd, hours);
        this.rotY(-mu.getMu());
    }
}
