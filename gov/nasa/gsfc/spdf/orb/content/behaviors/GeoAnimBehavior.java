 ...
 *
 * $Id: GeoAnimBehavior.java,v 1.2 2015/10/30 14:18:50 rchimiak Exp $
 */
 ...
 * @author rchimiak
 */
public class GeoAnimBehavior extends AnimBehavior {

    public GeoAnimBehavior(final TransformGroup target,
            final SatelliteData satLocation, final int j,
    ...
    protected List<XMLGregorianCalendar> getTime(Object satLocation) {
        ...
        return ((SatelliteData) satLocation).getTime();
